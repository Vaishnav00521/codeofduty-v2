...
import { BrainCircuit, TrendingUp, CloudRain, ShieldCheck, AlertOctagon, Map } from 'lucide-react';
  ...
  return (
    <div className="h-full flex-1 bg-[#141414] font-sans text-white p-5 relative overflow-hidden">
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="relative z-10 w-full h-full max-w-md mx-auto">
        ...
        {/* Base vs. Dynamic Price Card (Bento Box) */}
        <motion.div variants={itemVariants} className="mb-6">
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-xl rounded-3xl p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-between items-center text-sm font-medium">
                <span className="text-slate-400">AI Zone Multiplier (Koramangala Traffic)</span>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex justify-between items-end">
              <div>
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-extrabold text-white tracking-tighter">₹65</span>
          ...
          <div className="bg-slate-900/90 backdrop-blur-md border border-slate-700 shadow-xl rounded-3xl p-5 relative overflow-hidden">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-3 flex gap-3 relative z-10 backdrop-blur-md shadow-[0_0_10px_rgba(239,68,68,0.1)]">
              ...
              <p className="text-xs text-red-200 font-medium leading-relaxed">
                <span className="font-bold text-red-400 block mb-0.5">Zone: Koramangala.</span> 
                High probability of street flooding detected. Routing dynamic price adjustment.
              </p>
            </div>
          </div>
        </motion.div>

        {/* AI Fraud Prevention Engine Validation */}
